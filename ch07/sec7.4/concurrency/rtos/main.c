...
#define TL_W       RTOS_TIMELINE_LEN   /* 280px = 280ms of history */
#define TL_ROW_H    18
#define TL_ROW_GAP   4
 ...
 *
 * Holds the CPU for 200 ms (active_ms), then sleeps 300 ms.
 * During its active window it starves the Counter task entirely —
 * that preemption shows as a solid LED-coloured block on the timeline.
 * Period: 500 ms → clear, slow pulse easy to follow visually.
 */
