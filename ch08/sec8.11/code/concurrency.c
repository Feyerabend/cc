 ...
 *
 * --- Section 5: Why sequential Hoare proofs fail ---
 *
 ...
 *
 * --- Section 5.3: Resource invariant ---
 *
...
/* Section 5.3: Lock-protected counter with resource invariant */
...
{
    printf("-- Lock-Protected Counter (Sections 5.3 and 6.2) --\n\n");
...
/* Section 6: Rely-Guarantee -- monotone counter */
...
{
    printf("-- Rely-Guarantee Composition (Section 6) --\n\n");
...
/* Section 5.1: Illustrating why the race condition is a problem */
...
{
    printf("-- Race Condition: Why Sequential Proofs Fail (Section 5.1) --\n\n");
