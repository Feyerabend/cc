...
{
    printf("-- Null Pointer Dereference (Section 7.4) --\n\n");
...
{
    printf("-- Integer Overflow (Section 7.2) --\n\n");
 ...
 *
 * The incorrectness consequence rule (Section 7.3) lets us:
...
{
    printf("-- Incorrectness Consequence Rule (Section 7.3) --\n\n");
...
{
    printf("-- Hoare + Incorrectness: Complete Analysis (Section 7.1) --\n\n");
...
{
    printf("-- Off-By-One Bug (Section 7.2) --\n\n");
