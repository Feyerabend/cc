 ...
 *
 * In OCaml the map specification reads (Section 8.1):
 *
 *   ∀P Q f xs α.
 ...
 *
 * This realises the specification of 'filter' (Section 8.3):
 *   ∀x. pred(x) = true  ↔  Q(x)
 ...
 * semantics of Section 9.2 at the level of concrete lists.
 *
...
{
    printf("-- map: Parametric Specification (Section 8.1) --\n\n");
...
{
    printf("-- filter: Parametric Predicate (Section 8.3) --\n\n");
...
{
    printf("-- fold_left: Algebraic Laws (Sections 8 and 9) --\n\n");
