 ...
 *   (b) trace the loop invariant from Section 4.6 through the
...
/* In-place list reversal (Section 4.6) */
...
{
    printf("-- In-Place List Reversal (Section 4.6) --\n\n");
...
{
    printf("-- Frame Rule: Append (Section 4.4) --\n\n");
