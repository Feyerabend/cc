...
What *Perceptrons* truly marks is the moment when neural network research became mathematically serious
-- a shift from intuition-driven enthusiasm to formal, provable constraint. The XOR problem it
highlighted became the clearest illustration of why *depth* matters in a network, and stands today as
