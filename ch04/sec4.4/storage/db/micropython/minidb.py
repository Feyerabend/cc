...
# 2. Insert some rows
db.insert("temperature", [12345, 22.5])
db.insert("temperature", [12350, 22.7])

# 3. Read all rows
for row in db.all_rows("temperature"):
    print(row)

# 4. Filter (select where temp == 22.5)
for row in db.select("temperature", where={"temp": "22.5"}):
    print("Filtered:", row)
